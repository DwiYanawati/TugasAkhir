...
if model is not None:
    ...
    with tab_realtime:
        ...
        st.markdown('<div class="single-step-box"><div class="step-title-text">📋 Langkah Penggunaan:</div><ul class="step-list"><li><b>Mulai Deteksi:</b> Tekan tombol <b>"START"</b> pada jendela pemutar WebRTC.</li></ul></div>', unsafe_allow_html=True)
