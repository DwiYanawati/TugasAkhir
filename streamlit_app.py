    ...
    with tab_upload:
        ...
        st.markdown("""
            ...
            <div class="single-step-box">
                ...
                <div class="step-title-text">📋 Langkah Penggunaan:</div>

                <ul class="step-list">

                    <li><b>Unggah Citra Daun:</b> Klik area berkas di bawah untuk memasukkan foto daun kedelai (Format: JPG, JPEG, atau PNG).</li>

                    <li><b>Jalankan Inferensi:</b> Klik tombol hijau <b>"Deteksi Penyakit Daun Kedelai"</b> untuk memicu pemindaian model kecerdasan buatan YOLOv9.</li>

                    <li><b>Evaluasi Prediksi:</b> Tinjau area kanan untuk melihat hasil lokalisasi bercak serta akurasi presentase (Confidence Score).</li>
        ...
        st.markdown("""
            ...
            <div class="single-step-box">
                ...
                <ul class="step-list">
                    ...
                    <li><b>Izinkan Akses Perangkat:</b> Pastikan browser diberikan izin penuh untuk mengakses hardware webcam laptop Anda.</li>

                    <li><b>Mulai Deteksi:</b> Tekan tombol <b>"START"</b> pada jendela pemutar WebRTC untuk mengaktifkan pemindaian video langsung.</li>

                    <li><b>Deteksi Otomatis:</b> Hadapkan sisi fisik daun kedelai secara sejajar di depan lensa kamera hingga deteksi kotak otomatis muncul.</li>
