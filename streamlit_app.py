TAMBAHKAN JUDUL JENIS PENYAKIT DAUN SETELAH PENJELASAN AWAL DIHALAMAN UTAMAA UNTUK MEMBUKA PENJELASAN JENIS PENYAKIT DAUN import streamlit as st
import cv2
import numpy as np
...
        st.markdown('</div>', unsafe_allow_html=True)
        ...
        # ====== JUDUL BAGIAN BARU UNTUK MEMBUKA PENJELASAN JENIS PENYAKIT ======
