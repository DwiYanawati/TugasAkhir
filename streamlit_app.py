...
if model is not None:
    ...
    with tab_upload:
        ...
        # SATU KOTAK UTUH LANGKAH PENGGUNAAN UPLOAD
        st.markdown("""
            <div class="single-step-box">
                <div class="step-title-text">📋 Langkah Penggunaan Sistem Deteksi:</div>
                <ul class="step-list">
                    <li><b>1. Unggah Citra Daun:</b> Klik area berkas di bawah untuk memasukkan foto sampel daun kedelai (Format: JPG, JPEG, atau PNG).</li>
                    <li><b>2. Jalankan Inferensi:</b> Klik tombol hijau <b>"Jalankan Analisis Objek"</b> untuk memicu pemindaian model kecerdasan buatan YOLOv9.</li>
                    <li><b>3. Evaluasi Prediksi:</b> Tinjau area kanan untuk melihat hasil lokalisasi bercak serta akurasi presentase (Confidence Score).</li>
                </ul>
            </div>
        """, unsafe_allow_html=True)
    ...
    with tab_realtime:
        ...
        # SATU KOTAK UTUH LANGKAH PENGGUNAAN KAMERA REAL-TIME
        st.markdown("""
            <div class="single-step-box">
                <div class="step-title-text">📋 Langkah Penggunaan Kamera Real-Time:</div>
                <ul class="step-list">
                    <li><b>1. Izinkan Akses Perangkat:</b> Pastikan browser diberikan izin penuh untuk mengakses hardware webcam laptop Anda.</li>
                    <li><b>2. Mulai Streaming:</b> Tekan tombol <b>"START"</b> pada jendela pemutar WebRTC untuk mengaktifkan pemindaian video langsung.</li>
                    <li><b>3. Posisikan Sampel:</b> Hadapkan sisi fisik daun kedelai secara sejajar di depan lensa kamera hingga deteksi kotak otomatis muncul.</li>
                </ul>
            </div>
        """, unsafe_allow_html=True)
